...
class UtilityAppItem extends StatefulWidget {
  final AppModel app;
  const UtilityAppItem({super.key, required this.app});

  @override
  State<UtilityAppItem> createState() => _UtilityAppItemState();
}

class _UtilityAppItemState extends State<UtilityAppItem> {
      ...
      child: AnimatedContainer(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              border: Border.all(color: widget.app.borderColor, width: 2),
              borderRadius: BorderRadius.circular(12),
